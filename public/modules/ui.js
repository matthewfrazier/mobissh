...
export function initSessionMenu() {
  ...
  // Dismiss on outside tap — backdrop covers viewport including xterm.js canvas
  ...
  document.getElementById('fontDecBtn').addEventListener('click', (e) => {
    e.stopPropagation();
    _applyFontSize((parseInt(localStorage.getItem('fontSize')) || 14) - 1);
  });
